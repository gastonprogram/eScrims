package model.notifications.core;
...
public class NotificationService {
    ...
    /**
     * Notifica sobre la creación de un scrim que coincide con preferencias de usuarios.
     */
    public void notifyScrimCreated(Scrim scrim) {
        ...
        String message = String.format("Se creó un scrim de %s para %s. ¡Postúlate ahora!",
            scrim.getJuego(), scrim.getFechaHora());
    ...
    public void notifyLobbyArmado(Scrim scrim) {
        List<Usuario> participants = getUsersByIds(scrim.getListaPostulaciones());
    ...
    public void notifyConfirmadoTodos(Scrim scrim) {
        List<Usuario> participants = getUsersByIds(scrim.getListaConfirmaciones());
    ...
    public void notifyCancelado(Scrim scrim) {
        ...
        allUserIds.addAll(scrim.getListaPostulaciones());
        allUserIds.addAll(scrim.getListaConfirmaciones());
